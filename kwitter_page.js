    ...
    firebase.database().ref("/"+room_name).on('value', function(snapshot) {
      ...
      snapshot.forEach(function(childSnapshot) {
         ...
         if(childKey != "purpose")
         {
           ...
           row = "<h4> "+ name +"<img class='user_tick' src='tick.png'></h4><h4 class='message_h4'>"+ message +"</h4><button class='btn' id='"+firebase_message_id+"' value='"+like+"' onclick='update_Like(this.id)'>Like: "+ like +"</span></button><hr>";       
